    ...
    <div class="content">
      <div class="postDiv">
        <div class="contentHeader">
          <ul>
            <li><a id="posty" href="panelMyPosts.php" class="prolifeBtns">Moje posty</a></li>
            <ul><a id="zh" href="panelChPsswd.php" class="prolifeBtns">Zmiana hasla</a></ul>
            <li><a id="zm" href="panelChEml.php" class="prolifeBtns">Zmiana maila</a></li>
